...
import 'dart:async';
class Haryana extends StatefulWidget {

  @override
  _HaryanaState createState() => _HaryanaState();
}

class _HaryanaState extends State<Haryana> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][11]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][11]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][11]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('HARYANA',style:TextStyle(fontSize: 25,color: Colors.white,)),
