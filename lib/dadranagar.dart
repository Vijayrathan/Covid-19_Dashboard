...
import 'dart:async';
class Dadra extends StatefulWidget {

  @override
  _DadraState createState() => _DadraState();
}

class _DadraState extends State<Dadra> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][7]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][7]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][7]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('DADRA NAGAR & HAVELI',style:TextStyle(fontSize: 25,color: Colors.white,)),
