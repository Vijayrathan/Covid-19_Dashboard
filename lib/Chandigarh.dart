...
class Chandigarh extends StatefulWidget {
  ...
  @override
  _ChandigarhState createState() => _ChandigarhState();
}
...
class _ChandigarhState extends State<Chandigarh> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][5]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][5]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][5]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('CHANDIGARH',style:TextStyle(fontSize: 25,color: Colors.white,)),
