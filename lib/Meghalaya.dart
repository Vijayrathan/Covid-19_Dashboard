...
import 'dart:async';
class Meghalaya extends StatefulWidget {

  @override
  _MeghalayaState createState() => _MeghalayaState();
}

class _MeghalayaState extends State<Meghalaya> {
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('Meghalaya',style:TextStyle(fontSize: 25,color: Colors.white,)),
