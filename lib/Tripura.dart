...
import 'dart:async';
class Tripura extends StatefulWidget {

  @override
  _TripuraState createState() => _TripuraState();
}

class _TripuraState extends State<Tripura> {
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('TRIPURA',style:TextStyle(fontSize: 25,color: Colors.white,)),
