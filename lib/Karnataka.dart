...
class Karnataka extends StatefulWidget {
  ...
  @override
  _KarnatakaState createState() => _KarnatakaState();
}
...
class _KarnatakaState extends State<Karnataka> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][15]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][15]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][15]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    ...
    home: Scaffold(
            appBar: AppBar(title:Text('KARNATAKA',style:TextStyle(fontSize: 25,color: Colors.white,)),
