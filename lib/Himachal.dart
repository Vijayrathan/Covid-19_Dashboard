...
import 'dart:async';
class Himachal extends StatefulWidget {

  @override
  _HimachalState createState() => _HimachalState();
}

class _HimachalState extends State<Himachal> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][12]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][12]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][12]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('HIMACHAL PRADESH',style:TextStyle(fontSize: 25,color: Colors.white,)),
