...
import 'dart:async';
class Madhya extends StatefulWidget {

  @override
  _MadhyaState createState() => _MadhyaState();
}

class _MadhyaState extends State<Madhya> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][18]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][18]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][18]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('MADHYA PRADESH',style:TextStyle(fontSize: 25,color: Colors.white,)),
