...
class _KeralaState extends State<Kerala> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][16]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][16]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][16]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('KERALA',style:TextStyle(fontSize: 25,color: Colors.white,)),
