...
import 'dart:async';
class Uttarkhand extends StatefulWidget {

  @override
  _UttarkhandState createState() => _UttarkhandState();
}

class _UttarkhandState extends State<Uttarkhand> {
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('UTTARKHAND',style:TextStyle(fontSize: 25,color: Colors.white,)),
