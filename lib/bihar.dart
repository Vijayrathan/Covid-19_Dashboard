...
import 'dart:async';
class Bihar extends StatefulWidget {

  @override
  _BiharState createState() => _BiharState();
}

class _BiharState extends State<Bihar> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][4]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][4]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][4]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('BIHAR',style:TextStyle(fontSize: 25,color: Colors.white,)),
