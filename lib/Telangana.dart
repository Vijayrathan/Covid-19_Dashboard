...
import 'dart:async';
class Telangana extends StatefulWidget {

  @override
  _TelanganaState createState() => _TelanganaState();
}

class _TelanganaState extends State<Telangana> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][30]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][30]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][30]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('TELANGANA',style:TextStyle(fontSize: 25,color: Colors.white,)),
