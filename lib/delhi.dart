...
class _DelhiState extends State<Delhi> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][8]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][8]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][8]['discharged'].toString();
    print(confirmedData);
