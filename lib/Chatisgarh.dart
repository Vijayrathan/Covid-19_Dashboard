...
import 'dart:async';
class Chatisgarh extends StatefulWidget {

  @override
  _ChatisgarhState createState() => _ChatisgarhState();
}

class _ChatisgarhState extends State<Chatisgarh> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][6]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][6]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][6]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('CHHATTISGARH',style:TextStyle(fontSize: 25,color: Colors.white,)),
