...
import 'dart:async';
class Arunachal extends StatefulWidget {

  @override
  _ArunachalState createState() => _ArunachalState();
}

class _ArunachalState extends State<Arunachal> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][2]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][2]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][2]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('ARUNACHAL PRADHESH',style:TextStyle(fontSize: 25,color: Colors.white,)),
