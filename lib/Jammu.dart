...
import 'dart:async';
class Jammu extends StatefulWidget {

  @override
  _JammuState createState() => _JammuState();
}

class _JammuState extends State<Jammu> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][13]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][13]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][13]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('JAMMU & KASHMIR',style:TextStyle(fontSize: 25,color: Colors.white,)),
