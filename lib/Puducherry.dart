...
import 'dart:async';
class Puducherry extends StatefulWidget {

  @override
  _PuducherryState createState() => _PuducherryState();
}

class _PuducherryState extends State<Puducherry> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][25]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][25]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][25]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('PUDUCHERRY',style:TextStyle(fontSize: 25,color: Colors.white,)),
