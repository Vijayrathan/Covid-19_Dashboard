...
class _GoaState extends State<Goa> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][9]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][9]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][9]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('GOA',style:TextStyle(fontSize: 25,color: Colors.white,)),
