...
import 'dart:async';
class Assam extends StatefulWidget {

  @override
  _AssamState createState() => _AssamState();
}

class _AssamState extends State<Assam> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][3]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][3]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][3]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('ASSAM',style:TextStyle(fontSize: 25,color: Colors.white,)),
