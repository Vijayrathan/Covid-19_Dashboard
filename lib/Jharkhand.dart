...
import 'dart:async';
class Jharkhand extends StatefulWidget {

  @override
  _JharkhandState createState() => _JharkhandState();
}

class _JharkhandState extends State<Jharkhand> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][14]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][14]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][14]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('JHARKHAND',style:TextStyle(fontSize: 25,color: Colors.white,)),
