...
class Ladakh extends StatefulWidget {
  ...
  @override
  _LadakhState createState() => _LadakhState();
}
...
class _LadakhState extends State<Ladakh> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][17]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][17]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][17]['discharged'].toString();
    print(confirmedData);
