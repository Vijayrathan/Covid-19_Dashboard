...
class Gujarat extends StatefulWidget {
  @override
  _GujaratState createState() => _GujaratState();
}
...
class _GujaratState extends State<Gujarat> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][10]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][10]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][10]['discharged'].toString();
    print(confirmedData);
    http.Response response1 = await http.get(
        'https://api.covid19india.org/state_district_wise.json');
    data1 = response1.body;
    decodedData1= jsonDecode(data1);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('GUJARAT',style:TextStyle(fontSize: 25,color: Colors.white,)),
