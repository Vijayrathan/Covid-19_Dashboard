...
import 'dart:async';
class Uttarp extends StatefulWidget {

  @override
  _UttarpState createState() => _UttarpState();
}

class _UttarpState extends State<Uttarp> {
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('UTTAR PRADESH',style:TextStyle(fontSize: 25,color: Colors.white,)),
