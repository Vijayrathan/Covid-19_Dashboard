...
import 'dart:async';
class Maharastra extends StatefulWidget {

  @override
  _MaharastraState createState() => _MaharastraState();
}

class _MaharastraState extends State<Maharastra> {
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('MAHARASHTRA',style:TextStyle(fontSize: 25,color: Colors.white,)),
