...
class Andhra extends StatefulWidget {
  ...
  @override
  _AndhraState createState() => _AndhraState();
}

class _AndhraState extends State<Andhra> {
  ...
  Future<void> getData()async {
    ...
    String confirmedData = decodedData['data']['regional'][1]['totalConfirmed'].toString();
    String deathsData=decodedData['data']['regional'][1]['deaths'].toString();
    String dischargedData=decodedData['data']['regional'][1]['discharged'].toString();
    print(confirmedData);
  ...
  Widget build(BuildContext context){
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(title:Text('ANDHRA PRADHESH',style:TextStyle(fontSize: 25,color: Colors.white,)),
